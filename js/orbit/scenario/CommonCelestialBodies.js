...
define(
	[
		'jquery',
		'orbit/NameSpace',
		'orbit/scenario/MoonOsculating'
	],
	function($, ns, MoonOsculating){
		...
		/*
		var osculatingMoon = $.extend({}, common.moon, {, map:'img/venusmap.jpg'});
		common.osculatingMoon = osculatingMoon;/**/
